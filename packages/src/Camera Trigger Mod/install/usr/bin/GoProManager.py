...
class GoProManager():
    ...
    def handleRecordCommand(self, mode, command):
        ...
        # Send MAV_CMD_DO_DIGICAM_CONTROL shutter command to vehicle.
        # This will handle traditional cameras using ArduPilot camera shutters on a servo or relay output
        # This will fire regardless of a GoPro being connected to the Solo or not.
        msg = self.shotMgr.vehicle.message_factory.command_long_encode(
